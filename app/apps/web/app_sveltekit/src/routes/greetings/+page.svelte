<script lang="ts">
  ...
  {
    "id": "sample-completed",
    "title": "Greetings completed sample",
    "message": "Greetings completed sample",
...
<main>
  <div class="stack">
    <section class="card">
      ...
      <h1>Greetings</h1>
      <p>This SvelteKit page was generated from <code>greeting_list</code>.</p>
    </section>
