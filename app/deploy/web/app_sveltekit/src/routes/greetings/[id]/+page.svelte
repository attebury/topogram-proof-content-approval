<script lang="ts">
  ...
  {
    "id": "sample-active",
    "title": "Greeting Details sample",
    "message": "Greeting Details sample",
    "description": "Generated from Topogram UI contract metadata.",
    "category": "sample"
  },
  {
    "id": "sample-completed",
    "title": "Greeting Details completed sample",
    "message": "Greeting Details completed sample",
...
<main>
  <div class="stack">
    <section class="card">
      ...
      <p>This SvelteKit page was generated from <code>greeting_detail</code>.</p>
    </section>
