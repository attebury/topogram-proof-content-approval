<script lang="ts">
  ...
  {
    "id": "sample-active",
    "title": "Create Greeting sample",
    "message": "Create Greeting sample",
    "description": "Generated from Topogram UI contract metadata.",
    "category": "sample"
  },
  {
    "id": "sample-completed",
    "title": "Create Greeting completed sample",
    "message": "Create Greeting completed sample",
...
<main>
  <div class="stack">
    <section class="card">
      <p class="muted">form</p>
      <h1>Create Greeting</h1>
      <p>This SvelteKit page was generated from <code>greeting_create</code>.</p>
    </section>
